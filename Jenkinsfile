    ...
    stages {
        ...
        stage('Deploy to Dev') {
            ...
            steps {
                ...
                sh "docker run -d --name seonjiwon-spring-dev -p 12226:8080 -e hello=${HELLO_MSG} seonjiwon-spring-dev"
            }
        }
        ...
        stage('Approval') {
            ...
            steps {
                timeout(time: 30, unit: 'MINUTES') {
                    input message: '프로덕션 배포를 승인하시겠습니까?', ok: '배포'
                }
            }
        }
        ...
        stage('Deploy to Prod') {
            ...
            steps {
                ...
                sh "docker run -d --name seonjiwon-spring -p 12225:8080 -e hello=${HELLO_MSG} seonjiwon-spring"
            }
        }
    }
}